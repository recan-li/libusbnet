...
# 31 "src/proto/protobase.c" 2



# 33 "src/proto/protobase.c"
uint32_t recv_full(int fd, char* buf, uint32_t pending)
{
...
# 97 "src/proto/protobase.c"
   ...
   val = 
# 104 "src/proto/protobase.c" 3 4
        __bswap_32 (
# 104 "src/proto/protobase.c"
        val
# 104 "src/proto/protobase.c" 3 4
        )
# 104 "src/proto/protobase.c"
...
int unpack_size(const char* src, uint32_t* dst)
{
   ...
   if(c == 0x82) {
      *dst = 
# 121 "src/proto/protobase.c" 3 4
            (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 121 "src/proto/protobase.c"
            *((uint16_t*) (src + 1))
# 121 "src/proto/protobase.c" 3 4
            ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; })) 
# 121 "src/proto/protobase.c"
   ...
   if(c == 0x84) {
      *dst = 
# 127 "src/proto/protobase.c" 3 4
            __bswap_32 (
# 127 "src/proto/protobase.c"
            *((uint32_t*) (src + 1))
# 127 "src/proto/protobase.c" 3 4
            )
# 127 "src/proto/protobase.c"
...
unsigned as_uint(void* data, uint32_t bytes)
{
   ...
   case 2: val = 
# 139 "src/proto/protobase.c" 3 4
                (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 139 "src/proto/protobase.c"
                *((uint16_t*) data)
# 139 "src/proto/protobase.c" 3 4
                ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 139 "src/proto/protobase.c"
                                          ; break;
   case 4: val = 
# 140 "src/proto/protobase.c" 3 4
                __bswap_32 (
# 140 "src/proto/protobase.c"
                *((uint32_t*) data)
# 140 "src/proto/protobase.c" 3 4
                )
# 140 "src/proto/protobase.c"
...
int as_int(void* data, uint32_t bytes)
{
   ...
   case 2: val = 
# 152 "src/proto/protobase.c" 3 4
                (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 152 "src/proto/protobase.c"
                *((int16_t*) data)
# 152 "src/proto/protobase.c" 3 4
                ); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }))
# 152 "src/proto/protobase.c"
                                         ; break;
   case 4: val = 
# 153 "src/proto/protobase.c" 3 4
                __bswap_32 (
# 153 "src/proto/protobase.c"
                *((int32_t*) data)
# 153 "src/proto/protobase.c" 3 4
                )
# 153 "src/proto/protobase.c"
...
{
   int shm_id = 0;
   do { if(log_level() & MsgLog) { printf("IPC: creating segment at key 0x%x (%d bytes)", (0x2a2a2a2a), (512)); printf("\n"); }; } while(0);
   if((shm_id = shmget((0x2a2a2a2a), (512), 
# 169 "src/proto/protobase.c" 3 4
                                         01000
# 169 "src/proto/protobase.c"
                                                  |0666)) == -1) {
      perror("shmget");
   }
...
{
   do { if(log_level() & MsgLog) { printf("IPC: removing segment %d", shm_id); printf("\n"); }; } while(0);
   return shmctl(shm_id, 
# 179 "src/proto/protobase.c" 3 4
                        0
# 179 "src/proto/protobase.c"
                                , 
# 179 "src/proto/protobase.c" 3 4
                                  ((void *)0)
# 179 "src/proto/protobase.c"
...
static void* ipc_get_addr() {
   ...
   int shm_id = 0;
   if((shm_id = shmget((0x2a2a2a2a), (512), 0666)) != -1) {


      void* shm_addr = 
# 189 "src/proto/protobase.c" 3 4
                      ((void *)0)
# 189 "src/proto/protobase.c"
                          ;
      if ((shm_addr = shmat(shm_id, 
# 190 "src/proto/protobase.c" 3 4
                                   ((void *)0)
# 190 "src/proto/protobase.c"
                                       , 0)) != (void *) -1)
         return shm_addr;
   ...
   return 
# 195 "src/proto/protobase.c" 3 4
         ((void *)0)
# 195 "src/proto/protobase.c"
             ;
}
...
int ipc_get_remote()
{
   ...
   if(shm_addr != 
# 205 "src/proto/protobase.c" 3 4
                 ((void *)0)
# 205 "src/proto/protobase.c"
                     ) {
   ...
   do { if(log_level() & MsgLog) { printf("IPC: remote fd is %d\n", fd); printf("\n"); }; } while(0);
...
int ipc_set_remote(int fd)
{
   ...
   void* shm_addr = ipc_get_addr();
   if(shm_addr != 
# 233 "src/proto/protobase.c" 3 4
                 ((void *)0)
# 233 "src/proto/protobase.c"
                     ) {


      *((int*) shm_addr) = fd;
      do { if(log_level() & MsgLog) { printf("IPC: stored remote socket descriptor %d", fd); printf("\n"); }; } while(0);
