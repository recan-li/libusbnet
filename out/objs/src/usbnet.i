...
# 1 "src/usbnet.h" 1
# 29 "src/usbnet.h"
# 1 "/usr/include/usb.h" 1 3 4
# 14 "/usr/include/usb.h" 3 4
...
# 21 "/usr/include/usb.h" 2 3 4
# 68 "/usr/include/usb.h" 3 4
...
# 235 "/usr/include/usb.h" 3 4
struct usb_device;
struct usb_bus;
# 248 "/usr/include/usb.h" 3 4
struct usb_device {
...
typedef enum {
   NullRequest = CallType,
   UsbInit = CallType + 1,
   UsbFindBusses = CallType + 2,
   UsbFindDevices = CallType + 3,
   UsbGetBusses = CallType + 4,
   UsbOpen = CallType + 5,
   UsbClose = CallType + 6,
   UsbControlMsg = CallType + 7,
   UsbClaimInterface = CallType + 8,
   UsbReleaseInterface = CallType + 9,
   UsbGetKernelDriver = CallType + 10,
   UsbDetachKernelDriver = CallType + 11,
   UsbBulkRead = CallType + 12,
   UsbBulkWrite = CallType + 13,
   UsbSetConfiguration = CallType + 14,
   UsbSetAltInterface = CallType + 15,
   UsbResetEp = CallType + 16,
   UsbClearHalt = CallType + 17,
   UsbReset = CallType + 18,
   UsbInterruptRead = CallType + 19,
   UsbInterruptWrite = CallType + 20
...
# 31 "src/usbnet.c" 2
# 1 "./src/proto/protocol.h" 1
# 25 "./src/proto/protocol.h"
       
# 60 "./src/proto/protocol.h"
typedef struct {
   uint32_t bufsize;
   uint32_t size;
   uint8_t op;
...
static struct usb_bus* __orig_bus = 
# 49 "src/usbnet.c" 3 4
                                     ((void *)0)
# 49 "src/usbnet.c"
                                         ;
static struct usb_bus* __remote_bus = 
# 50 "src/usbnet.c" 3 4
                                     ((void *)0)
# 50 "src/usbnet.c"
                                         ;
...
void session_teardown() {
   ...
   do { if(log_level() & MsgDebug) { fprintf(
# 56 "src/usbnet.c" 3 4
  stderr
# 56 "src/usbnet.c"
  , "%s: ", __func__); fprintf(
...
# 60 "src/usbnet.c" 3 4
  stderr
# 60 "src/usbnet.c"
  , "deallocating shared packet ..."); fprintf(
# 60 "src/usbnet.c" 3 4
  stderr
# 60 "src/usbnet.c"
  , "\n"); }; } while(0);
...
# 108 "src/usbnet.c" 3 4
     stderr
# 108 "src/usbnet.c"
     , "IPC: unable to access remote fd"); fprintf(
# 108 "src/usbnet.c" 3 4
     stderr
# 108 "src/usbnet.c"
     , "\n"); }; } while(0);
...
int usb_find_busses(void)
{
   ...
   int res = 0;
   Iterator it;
   if(pkt_recv(fd, pkt) > 0 && ((pkt)->op) == UsbFindBusses) {
      if(pkt_begin(pkt, &it) != 
# 157 "src/usbnet.c" 3 4
                               ((void *)0)
# 157 "src/usbnet.c"
                                   ) {
         res = ((&as_int)(iter_nextval(((&it))), (&it)->len));
      }
   }
...
# 204 "src/usbnet.c"
            ...
            strcpy(rbus->dirname, ((&as_string)(iter_nextval(((&it))), (&it)->len)));


            rbus->location = ((&as_uint)(iter_nextval(((&it))), (&it)->len));
...
# 236 "src/usbnet.c"
               ...
               strcpy(dev->filename, ((&as_string)(iter_nextval(((&it))), (&it)->len)));


               dev->devnum = ((&as_uint)(iter_nextval(((&it))), (&it)->len));



               memcpy(&dev->descriptor, it.val, it.len);
               dev->descriptor.bcdUSB = 
# 251 "src/usbnet.c" 3 4
...
# 287 "src/usbnet.c"
                  ...
                  for(i = 0; i < cfg->bNumInterfaces; ++i) {
                     ...
                     iface->num_altsetting = ((&as_int)(iter_nextval(((&it))), (&it)->len));
...
# 356 "src/usbnet.c"
            ...
            while(dev->next != 
# 365 "src/usbnet.c" 3 4
                              ((void *)0)
# 365 "src/usbnet.c"
                                  ) {
               struct usb_device* ddev = dev->next;
               do { if(log_level() & MsgDebug) { fprintf(
# 367 "src/usbnet.c" 3 4
              stderr
# 367 "src/usbnet.c"
              , "%s: ", __func__); fprintf(
# 367 "src/usbnet.c" 3 4
              stderr
# 367 "src/usbnet.c"
              , "deleting device %03d", ddev->devnum); fprintf(
# 367 "src/usbnet.c" 3 4
              stderr
# 367 "src/usbnet.c"
              , "\n"); }; } while(0);
...
# 374 "src/usbnet.c" 3 4
           stderr
# 374 "src/usbnet.c"
           , "unexpected item identifier 0x%02x", it.type); fprintf(
# 374 "src/usbnet.c" 3 4
           stderr
# 374 "src/usbnet.c"
           , "\n"); }; } while(0);
      ...
      while(rbus->next != 
# 380 "src/usbnet.c" 3 4
                         ((void *)0)
# 380 "src/usbnet.c"
                             ) {
         do { if(log_level() & MsgDebug) { fprintf(
# 381 "src/usbnet.c" 3 4
        stderr
# 381 "src/usbnet.c"
        , "%s: ", __func__); fprintf(
# 381 "src/usbnet.c" 3 4
        stderr
# 381 "src/usbnet.c"
        , "deleting bus %03d", rbus->next->location); fprintf(
# 381 "src/usbnet.c" 3 4
        stderr
# 381 "src/usbnet.c"
        , "\n"); }; } while(0);
      ...
      if(__remote_bus == 
# 387 "src/usbnet.c" 3 4
                        ((void *)0)
# 387 "src/usbnet.c"
                            ) {
         __orig_bus = usb_busses;
         do { if(log_level() & MsgDebug) { fprintf(
# 389 "src/usbnet.c" 3 4
        stderr
# 389 "src/usbnet.c"
        , "%s: ", __func__); fprintf(
# 389 "src/usbnet.c" 3 4
        stderr
# 389 "src/usbnet.c"
        , "overriding global usb_busses from %p to %p", usb_busses, vbus.next); fprintf(
# 389 "src/usbnet.c" 3 4
        stderr
# 389 "src/usbnet.c"
        , "\n"); }; } while(0);
...
# 407 "src/usbnet.c" 3 4
  stderr
# 407 "src/usbnet.c"
  , "returned %p", __remote_bus); fprintf(
# 407 "src/usbnet.c" 3 4
  stderr
# 407 "src/usbnet.c"
  , "\n"); }; } while(0);
...
usb_dev_handle *usb_open(struct usb_device *dev)
{
   ...
   pkt_addnumeric((pkt), UnsignedType, sizeof(dev->bus->location), (dev->bus->location));
   pkt_addnumeric((pkt), UnsignedType, sizeof(dev->devnum), (dev->devnum));
   pkt_send(pkt, fd);


   int res = -1, devfd = -1;
   if(pkt_recv(fd, pkt) > 0 && ((pkt)->op) == UsbOpen) {
      Iterator it;
      pkt_begin(pkt, &it);
      res = ((&as_int)(iter_nextval(((&it))), (&it)->len));
      devfd = ((&as_int)(iter_nextval(((&it))), (&it)->len));
   }


   usb_dev_handle* udev = 
# 437 "src/usbnet.c" 3 4
                         ((void *)0)
# 437 "src/usbnet.c"
                             ;
   if(res >= 0) {
...
# 447 "src/usbnet.c" 3 4
  stderr
# 447 "src/usbnet.c"
  , "returned %d (fd %d)", res, devfd); fprintf(
# 447 "src/usbnet.c" 3 4
  stderr
# 447 "src/usbnet.c"
  , "\n"); }; } while(0);
...
int usb_close(usb_dev_handle *dev)
{
   ...
   pkt_addnumeric((pkt), IntegerType, sizeof(dev->fd), (dev->fd));
   pkt_send(pkt, fd);
   ...
   int res = -1;
   if(pkt_recv(fd, pkt) > 0 && ((pkt)->op) == UsbClose) {
      Iterator it;
      pkt_begin(pkt, &it);
      res = ((&as_int)(iter_nextval(((&it))), (&it)->len));
   }
...
int usb_set_configuration(usb_dev_handle *dev, int configuration)
{
   ...
   pkt_addnumeric((pkt), IntegerType, sizeof(dev->fd), (dev->fd));
   pkt_addnumeric((pkt), IntegerType, sizeof(configuration), (configuration));
   pkt_send(pkt, fd);


   int res = -1;
   if(pkt_recv(fd, pkt) > 0 && ((pkt)->op) == UsbSetConfiguration) {
      Iterator it;
      pkt_begin(pkt, &it);
      ...
      configuration = ((&as_int)(iter_nextval(((&it))), (&it)->len));
   }
...
int usb_set_altinterface(usb_dev_handle *dev, int alternate)
{
   ...
   pkt_addnumeric((pkt), IntegerType, sizeof(dev->fd), (dev->fd));
   pkt_addnumeric((pkt), IntegerType, sizeof(alternate), (alternate));
   pkt_send(pkt, fd);


   int res = -1;
   if(pkt_recv(fd, pkt) > 0 && ((pkt)->op) == UsbSetAltInterface) {
      Iterator it;
      pkt_begin(pkt, &it);
      ...
      alternate = ((&as_int)(iter_nextval(((&it))), (&it)->len));
   }
...
int usb_resetep(usb_dev_handle *dev, unsigned int ep)
{
   ...
   pkt_addnumeric((pkt), IntegerType, sizeof(dev->fd), (dev->fd));
   pkt_addnumeric((pkt), UnsignedType, sizeof(ep), (ep));
   pkt_send(pkt, fd);


   int res = -1;
   if(pkt_recv(fd, pkt) > 0 && ((pkt)->op) == UsbResetEp) {
      Iterator it;
      pkt_begin(pkt, &it);
...
int usb_clear_halt(usb_dev_handle *dev, unsigned int ep)
{
   ...
   int res = -1;
   if(pkt_recv(fd, pkt) > 0 && ((pkt)->op) == UsbClearHalt) {
      Iterator it;
      pkt_begin(pkt, &it);
...
int usb_reset(usb_dev_handle *dev)
{
   ...
   int res = -1;
   if(pkt_recv(fd, pkt) > 0 && ((pkt)->op) == UsbReset) {
      Iterator it;
      pkt_begin(pkt, &it);
...
int usb_claim_interface(usb_dev_handle *dev, int interface)
{
   ...
   pkt_addnumeric((pkt), IntegerType, sizeof(dev->fd), (dev->fd));
   pkt_addnumeric((pkt), IntegerType, sizeof(interface), (interface));
   pkt_send(pkt, fd);


   int res = -1;
   if(pkt_recv(fd, pkt) > 0 && ((pkt)->op) == UsbClaimInterface) {
      Iterator it;
      pkt_begin(pkt, &it);
      res = ((&as_int)(iter_nextval(((&it))), (&it)->len));
   }
...
int usb_release_interface(usb_dev_handle *dev, int interface)
{
   ...
   int res = -1;
   if(pkt_recv(fd, pkt) > 0 && ((pkt)->op) == UsbReleaseInterface) {
      Iterator it;
      pkt_begin(pkt, &it);
      res = ((&as_int)(iter_nextval(((&it))), (&it)->len));
   }
        ...
        int value, int index, char *bytes, int size, int timeout)
{
   ...
   pkt_addnumeric((pkt), IntegerType, sizeof(dev->fd), (dev->fd));
   pkt_addnumeric((pkt), IntegerType, sizeof(requesttype), (requesttype));
   pkt_addnumeric((pkt), IntegerType, sizeof(request), (request));
   pkt_addnumeric((pkt), IntegerType, sizeof(value), (value));
   pkt_addnumeric((pkt), IntegerType, sizeof(index), (index));
   pkt_append((pkt), OctetType, (size), (bytes));
   pkt_addnumeric((pkt), IntegerType, sizeof(timeout), (timeout));
   pkt_send(pkt, fd);


   int res = -1;
   if(pkt_recv(fd, pkt) > 0 && ((pkt)->op) == UsbControlMsg) {
      Iterator it;
      pkt_begin(pkt, &it);
      res = ((&as_int)(iter_nextval(((&it))), (&it)->len));
...
int usb_bulk_read(usb_dev_handle *dev, int ep, char *bytes, int size, int timeout)
{
   ...
   pkt_addnumeric((pkt), IntegerType, sizeof(dev->fd), (dev->fd));
   pkt_addnumeric((pkt), IntegerType, sizeof(ep), (ep));
   pkt_addnumeric((pkt), IntegerType, sizeof(size), (size));
   pkt_addnumeric((pkt), IntegerType, sizeof(timeout), (timeout));
   pkt_send(pkt, fd);


   int res = -1;
   if(pkt_recv(fd, pkt) > 0 && ((pkt)->op) == UsbBulkRead) {
...
int usb_bulk_write(usb_dev_handle *dev, int ep, const char * bytes, int size, int timeout)
{
   ...
   int res = -1;
   if(pkt_recv(fd, pkt) > 0 && ((pkt)->op) == UsbBulkWrite) {
      Iterator it;
      pkt_begin(pkt, &it);
      res = ((&as_int)(iter_nextval(((&it))), (&it)->len));
   }
...
int usb_interrupt_write(usb_dev_handle *dev, int ep, const char * bytes, int size, int timeout)
{
   ...
   int res = -1;
   if(pkt_recv(fd, pkt) > 0 && ((pkt)->op) == UsbInterruptWrite) {
      Iterator it;
      pkt_begin(pkt, &it);
      res = ((&as_int)(iter_nextval(((&it))), (&it)->len));
   }
...
int usb_interrupt_read(usb_dev_handle *dev, int ep, char *bytes, int size, int timeout)
{
   ...
   int res = -1;
   if(pkt_recv(fd, pkt) > 0 && ((pkt)->op) == UsbInterruptRead) {
      Iterator it;
      pkt_begin(pkt, &it);
      res = ((&as_int)(iter_nextval(((&it))), (&it)->len));
...
int usb_get_driver_np(usb_dev_handle *dev, int interface, char *name, unsigned int namelen)
{
   ...
   pkt_addnumeric((pkt), IntegerType, sizeof(dev->fd), (dev->fd));
   pkt_addnumeric((pkt), IntegerType, sizeof(interface), (interface));
   pkt_addnumeric((pkt), UnsignedType, sizeof(namelen), (namelen));
   pkt_send(pkt, fd);


   int res = -1;
   if(pkt_recv(fd, pkt) > 0 && ((pkt)->op) == UsbGetKernelDriver) {
      Iterator it;
      pkt_begin(pkt, &it);
      res = ((&as_int)(iter_nextval(((&it))), (&it)->len));
      ...
      if(res) {
         do { if(log_level() & MsgError) { fprintf(
# 888 "src/usbnet.c" 3 4
        stderr
# 888 "src/usbnet.c"
        , "%s: could not get bound driver", __func__); fprintf(
# 888 "src/usbnet.c" 3 4
        stderr
# 888 "src/usbnet.c"
        , "\n"); }; } while(0);
      ...
      strncpy(name, ((&as_string)(iter_nextval(((&it))), (&it)->len)), namelen - 1);
      name[namelen - 1] = '\0';
   }

   pkt_release();
   do { if(log_level() & MsgDebug) { fprintf(
# 897 "src/usbnet.c" 3 4
  stderr
# 897 "src/usbnet.c"
  , "%s: ", __func__); fprintf(
# 897 "src/usbnet.c" 3 4
...
int usb_detach_kernel_driver_np(usb_dev_handle *dev, int interface)
{
   ...
   int res = -1;
   if(pkt_recv(fd, pkt) > 0 && ((pkt)->op) == UsbDetachKernelDriver) {
      Iterator it;
      pkt_begin(pkt, &it);
      res = ((&as_int)(iter_nextval(((&it))), (&it)->len));
   }
...
# 951 "src/usbnet.c"
                                                                    ,
                        (
# 952 "src/usbnet.c" 3 4
                        0x03 
# 952 "src/usbnet.c"
                                      << 8) + index, langid, buf, buflen, 1000);
}
...
# 971 "src/usbnet.c"
  ...
  if (tbuf[1] != 
# 979 "src/usbnet.c" 3 4
                0x03
# 979 "src/usbnet.c"
                             )
    return -
# 980 "src/usbnet.c" 3 4
           5
# 980 "src/usbnet.c"
              ;
